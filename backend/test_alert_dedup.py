...
def test_alert_deduplication():
    ...
    mock_coin_1 = {
        ...
        "retest_bar": {"time_str": "08-30 01:15"},
    }
    ...
    # Simulate processing retest
    stages = {"retesting": [mock_coin_1], "confirmed": []}
    service._process_stage_alerts(stages, "PDH_PDL", "1h")
    ...
    mock_coin_1["confirmed_bar"] = {"time_str": "08-30 01:30"}
    stages_conf = {"retesting": [], "confirmed": [mock_coin_1]}
    service._process_stage_alerts(stages_conf, "PDH_PDL", "1h")
    ...
    mock_coin_2 = {
        ...
        "retest_bar": {"time_str": "08-31 02:15"},
    }
    id2 = service._get_setup_identifier(mock_coin_2, "PDH_PDL", "1h")
    print("New Setup ID 2:", id2)
    assert id2 != id1
    service._process_stage_alerts({"retesting": [mock_coin_2], "confirmed": []}, "PDH_PDL", "1h")
